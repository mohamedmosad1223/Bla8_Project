  ...
  <div className="nreq-detail-page" dir="rtl">
    ...
    <div className="nreq-detail-card">
      ...
      <div className="nreq-drow">
        ...
        <NField label="اسم الداعي" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>}>
          {detail.submitted_by_name || 'لا يوجد'}
        </NField>
