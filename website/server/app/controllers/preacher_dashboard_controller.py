...
class PreacherDashboardController:
    ...
    def get_dashboard_stats(db: Session, preacher_id: int, user_id: int):
        ...
        response_speed_chart = [
            {"label": r.month.strftime("%b %Y") if r.month else "Unknown", "value": round(r.avg_speed, 2)} 
        ...
        return {
            ...
            "engagement_count": {"title": "إجمالي التفاعل", "value": engagement_count, "change_percentage": 12.0, "is_positive": True},
            ...
            "ai_suggestions_rate": ai_suggestions_rate,
