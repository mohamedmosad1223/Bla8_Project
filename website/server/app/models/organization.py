...
class Organization(Base):
    ...
    license_number:     Mapped[str]            = mapped_column(sa.String(100), nullable=False)
    license_file:       Mapped[str]            = mapped_column(sa.String(500), nullable=False)
    establishment_date: Mapped[date]           = mapped_column(sa.Date, nullable=False)
    country_id:         Mapped[int]            = mapped_column(sa.Integer, sa.ForeignKey("countries.country_id"), nullable=False)
    governorate:        Mapped[str]            = mapped_column(sa.String(150), nullable=False)
