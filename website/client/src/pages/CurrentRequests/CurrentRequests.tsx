...
const DetailView = ({ detail, onBack }: { detail: RequestDetail; onBack: () => void }) => (
  <div className="creq-detail-page">
    {/* Breadcrumb */}
    <div className="breadcrumb creq-breadcrumb">
      <button className="breadcrumb-link" onClick={onBack}>طلبات الدعوة الحالية</button>
      <ChevronRight size={14} className="breadcrumb-separator" />
      <span className="breadcrumb-current">عرض الطلب الحالي</span>
    </div>
    <h1 className="page-title">عرض الطلب الحالي</h1>

    <div className="creq-detail-card">
      {/* Group 1: الأساسيات */}
      <div className="creq-detail-grid">
        <div className="creq-detail-field">
          <span className="creq-field-label">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>
            اسم الشخص
          </span>
          <span className="creq-field-value">{detail.donorName}</span>
        </div>
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value">{detail.nationality}</span>
        </div>
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value">{detail.language}</span>
        </div>
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value">{detail.religion}</span>
        </div>
      </div>

      {/* Group 2: معلومات إضافية */}
      <div className="creq-detail-grid">
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value">{detail.age} عام</span>
        </div>
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value">{detail.gender}</span>
        </div>
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value" dir="ltr">{detail.phone}</span>
        </div>
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <span className="creq-field-value">{detail.email}</span>
        </div>
      </div>

      <div style={{ height: '1px', background: '#edf2f7', margin: '8px 0 40px' }} />

      {/* Row 3: Relationships & Contact */}
      <div className="creq-detail-grid">
        <div /> {/* Right Empty */}
        <div className="creq-detail-field">
          <span className="creq-field-label">
          ...
          <div className="creq-caller-value">
            <div className="creq-caller-avatar">{detail.callerName.charAt(0)}</div>
            <span>{detail.callerName}</span>
          </div>
        </div>

        <div className="creq-detail-field" style={{ gridColumn: 'span 2' }}>
          <span className="creq-field-label">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            طرق التواصل
          </span>
          <div className="creq-contact-value">
            <span className="creq-contact-badge">
      ...
      <div className="creq-personal-comment-section">
        <div className="creq-detail-field">
          <span className="creq-field-label">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
            التعليق الخاص بالشخص
          </span>
          <p className="creq-personal-comment-text">{detail.personalComment}</p>
        </div>
      </div>
      ...
      <div className="creq-personal-comment-section">
        <div className="creq-detail-field">
          ...
          <p className="creq-personal-comment-text">{detail.callerNote}</p>
        </div>
      </div>
    </div>
  </div>
                      ...
                      {openAccordion === 'language' && (
                        <div className="creq-filter-submenu-list creq-bordered-list mt-3">
                          {availableLanguages.map(lang => {
                            ...
                            return (
                              <label key={lang} className="creq-submenu-item" onClick={(e) => { e.preventDefault(); sel ? removeLanguage(lang) : addLanguage(lang); }}>
